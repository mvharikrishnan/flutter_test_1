...
class ShowAlert {
  static void showAlert(String msg) {
    Fluttertoast.showToast(
        ...
        textColor: AppColours.white,fontSize:15 );
  }

  static void showStyledToast(String msg,BuildContext context,{Color backgroundColor = AppColours.secondary}) {
    showToast(msg,
      context: context,
      ...
      textStyle: Styles.of(context).headStyle1.copyWith(
        fontSize: 15,
